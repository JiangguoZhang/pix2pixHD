...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/media/xavier/Storage/Tao-ImageSet/training-set/train')
        ...
        self.parser.add_argument('--input_condition_range', type=float, default=[-5, 0], help="The input condition")
        self.parser.add_argument('--output_condition_range', type=float, default=[0, 0], help="The specified output condition, which is required for testing")
        self.parser.add_argument('--synthesized', action='store_true', default=False, help='if specified, use tensorboard logging. Requires tensorflow installed')
